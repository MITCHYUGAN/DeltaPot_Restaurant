            ...
            <Route
              ...
              element={
                <Menu
                  ...
                  onOrderNowSingle={handleOrderNowSingle}
                  cartCount={cartCount}
            ...
            {toasts.map((toast) => (
              ...
              >
                {toast.type === 'success' ? (
                  ...
                  <Info className="w-5 h-5 text-brand-red flex-shrink-0 animate-pulse" />
                )}
                <div className="flex-1">
                  <p className="font-semibold uppercase tracking-wider text-[10px] text-brand-gold">
                    Notification
                  </p>
                  <p className="text-brand-cream/90 mt-0.5 leading-relaxed">
                    {toast.message}
                  </p>
                </div>
              </motion.div>
