        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="visible" className="lg:col-span-7 space-y-6">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h1 className="font-heading text-5xl sm:text-7xl font-extrabold tracking-tight leading-none text-white">
                Real Taste of <br />
          ...
          <div className="hidden lg:col-span-5 relative flex justify-center items-center">
            ...
            >
              ...
              <span className="font-heading text-amber-200/80 text-xs italic tracking-wider block mb-1">Traditional Urhobo Feast</span>
              <h3 className="font-heading text-2xl font-bold text-white mb-2">Banga Rice Fiesta</h3>
