...
export default function MapSection() {
  ...
  const googleMapEmbedUrl =
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.673858004523!2d3.4682006760592965!3d6.448744024046183!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103bf47b0a72adcd%3A0x673dbb3cdb129dd9!2s18B%20Emmanuel%20Abimbola%20Cole%20St%2C%20Lekki%20Phase%20I%2C%20Lekki%20106104%2C%20Lagos!5e0!3m2!1sen!2sng!4v1717610000000!5m2!1sen!2sng";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-8">
            <div className="space-y-4">
              ...
              <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-white leading-tight">Our Nest in Lekki</h2>
            ...
            <div className="space-y-4">
              <div className="p-5 bg-brand-dark border border-brand-gold/15 rounded-lg flex items-start gap-4 hover:border-brand-gold/30 transition-all">
                ...
                <div>
                  <h4 className="font-heading text-base font-semibold text-white">Full Address</h4>
                  <p className="font-sans text-sm text-brand-cream/70 leading-relaxed mt-1">{RESTAURANT_SETTINGS.address}</p>
                </div>
              </div>
              ...
              <div className="p-5 bg-brand-dark border border-brand-gold/15 rounded-lg flex items-start gap-4 hover:border-brand-gold/30 transition-all">
                ...
                <div>
                  <h4 className="font-heading text-base font-semibold text-white">Parking & Security</h4>
                  <p className="font-sans text-sm text-brand-cream/70 mt-1 leading-relaxed">Secure compound street parking with 24/7 dedicated security personnel on ground.</p>
                </div>
              </div>
              ...
              <div className="p-5 bg-brand-dark border border-brand-gold/15 rounded-lg flex items-start gap-4 hover:border-brand-gold/30 transition-all">
                ...
                <div>
                  <h4 className="font-heading text-base font-semibold text-white">Reservation & Large Events</h4>
          ...
          <div className="lg:col-span-7 h-[450px] lg:h-auto rounded-xl overflow-hidden border border-brand-gold/15 shadow-2xl relative group">
            ...
            <div className="absolute bottom-4 left-4 p-3 bg-brand-dark/95 border border-brand-gold/30 rounded-lg shadow-lg flex items-center gap-2 max-w-xs transition-opacity duration-300">
              ...
              <div>
                <p className="text-xs font-bold text-white font-heading">DeltaPot Lekki</p>
