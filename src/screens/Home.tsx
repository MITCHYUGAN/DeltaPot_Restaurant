      ...
      <section className="bg-brand-dark/40 py-20 border-t border-brand-gold/10" id="experience">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            ...
            <h2 className="font-heading text-3xl sm:text-5xl font-extrabold text-white">Why DeltaPot Stands Out</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {RESTAURANT_FEATURES.map((feat, index) => (
              ...
              >
                ...
                <h3 className="font-heading text-xl sm:text-2xl font-bold text-white mb-3 group-hover:text-brand-gold transition-colors">{feat.title}</h3>
                <p className="text-xs sm:text-sm text-brand-cream/70 font-sans font-light leading-relaxed">{feat.description}</p>
              </motion.div>
            ))}
          </div>
